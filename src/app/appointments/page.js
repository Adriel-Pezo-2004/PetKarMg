            ...
            <div className="space-y-4">
              <ul className="space-y-4">
                {appointments.map((appointment) => (
                  ...
                  >
                    <h3 className="text-lg font-bold text-indigo-600">{appointment.title}</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
                      <div>
                        <p className="text-sm text-gray-600">Tipo: <span className="text-gray-800">{appointment.type}</span></p>
                        <p className="text-sm text-gray-600">Descripción: <span className="text-gray-800">{appointment.description || 'N/A'}</span></p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Fecha: <span className="text-gray-800">{new Date(appointment.date).toLocaleDateString()}</span></p>
                        <p className="text-sm text-gray-600">Hora: <span className="text-gray-800">{appointment.time}</span></p>
                      </div>
                    </div>
                  </li>
                ))}
